...
While there are 20 possible Pokemon types, I'm not interested the information offered in the shadow or unknown Pokemon. The shadow Pokemon only offers moves that are available for that Pokemon type because it's not a real type of Pokemon. The shadow type aren't actual Pokemon type; they're regular Pokemon whose heart has turned to darkness. The unknown Pokemon only have data about the generation of game that this Pokemon type appeared in, but don't seem to contain any Pokemon species.
